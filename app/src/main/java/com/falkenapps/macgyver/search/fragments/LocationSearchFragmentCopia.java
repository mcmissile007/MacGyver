 ...
 */
public class LocationSearchFragmentCopia extends Fragment {
    ...
    public LocationSearchFragmentCopia() {
        // Required empty public constructor
    }

    public static LocationSearchFragmentCopia newInstance(int page){
        Log.d(ACTIVITY_TAG,"NewInstance LocationSearchFragment:" + page);
        LocationSearchFragmentCopia fragment = new LocationSearchFragmentCopia();
