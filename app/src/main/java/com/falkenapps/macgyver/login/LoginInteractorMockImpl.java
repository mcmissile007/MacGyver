...
/**
 * Created by FalkenApps:falken on 3/3/17.
 */

public class LoginInteractorMockImpl implements LoginInteractor{
    private LoginRepository loginRepository;

    @Inject //decorator not required
    public LoginInteractorMockImpl(LoginRepository loginRepository){
    ...
    @Override
    public void doSignInWithEmail(String email, String password, SingleObserver singleObserver) {



        loginRepository.signInWithEmail(email, password, singleObserver);
